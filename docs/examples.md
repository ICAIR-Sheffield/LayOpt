...
youngs_modulus: 1.0 # Material stiffness (used for elastic design only)
avg_deflection_limit: -1.0 # Limit on weighted average of loaded points in elastic design. 
